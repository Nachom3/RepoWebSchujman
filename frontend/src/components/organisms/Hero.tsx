...
import { DashboardMetric } from '../molecules/DashboardMetric'
import { DashboardRow } from '../molecules/DashboardRow'
...
export function Hero({ isAuthenticated, onNavigate, scrollTo }: Readonly<HeroProps>) {
  return (
    <section
      id="hero"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div className="text-center lg:text-left" {...fadeInUp}>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              {isAuthenticated ? (
                <Button variant="accent" size="lg" onClick={() => onNavigate('/dashboard')}>
                  Ir al dashboard
                </Button>
              ) : (
                <>
                  <Button variant="accent" size="lg" onClick={() => onNavigate('/register')}>
                    Agendar demo
                  </Button>
          ...
          >
            ...
            >
              ...
              <Card surface="solid" padding="sm" className="relative !rounded-2xl space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  {heroMetrics.map((m) => (
                    <DashboardMetric key={m.label} label={m.label} value={m.value} bg={m.bg} />
                  ))}
                </div>
